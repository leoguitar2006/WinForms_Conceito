...
namespace WinForms {
    ...
    public partial class CRUDDataSet : global::System.Data.DataSet {
        ...
        public partial class CLIENTESDataTable : global::System.Data.TypedTableBase<CLIENTESRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CLIENTESRow AddCLIENTESRow(string NOME, System.DateTime DATANASC, decimal SALARIO) {
            ...
            public System.DateTime DATANASC {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'DATANASC\' in table \'CLIENTES\' is DBNull.", e);
                    }
                }
                set {
...
namespace WinForms.CRUDDataSetTableAdapters {
    ...
    public partial class CLIENTESTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[CLIENTES] WHERE (([ID] = @Original_ID) AND ((@IsNull_NOME = 1 AND [NOME] IS NULL) OR ([NOME] = @Original_NOME)) AND ((@IsNull_DATANASC = 1 AND [DATANASC] IS NULL) OR ([DATANASC] = @Original_DATANASC)) AND ((@IsNull_SALARIO = 1 AND [SALARIO] IS NULL) OR ([SALARIO] = @Original_SALARIO)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CLIENTES] ([NOME], [DATANASC], [SALARIO]) VALUES (@NOME, @DATA" +
                "NASC, @SALARIO);\r\nSELECT ID, NOME, DATANASC, SALARIO FROM CLIENTES WHERE (ID = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CLIENTES] SET [NOME] = @NOME, [DATANASC] = @DATANASC, [SALARIO] = @SALARIO WHERE (([ID] = @Original_ID) AND ((@IsNull_NOME = 1 AND [NOME] IS NULL) OR ([NOME] = @Original_NOME)) AND ((@IsNull_DATANASC = 1 AND [DATANASC] IS NULL) OR ([DATANASC] = @Original_DATANASC)) AND ((@IsNull_SALARIO = 1 AND [SALARIO] IS NULL) OR ([SALARIO] = @Original_SALARIO)));
SELECT ID, NOME, DATANASC, SALARIO FROM CLIENTES WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinForms.Properties.Settings.Default.CRUDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, NOME, DATANASC, SALARIO FROM dbo.CLIENTES";
        ...
        public virtual int Delete(int Original_ID, string Original_NOME, global::System.Nullable<global::System.DateTime> Original_DATANASC, global::System.Nullable<decimal> Original_SALARIO) {
        ...
        public virtual int Insert(string NOME, global::System.Nullable<global::System.DateTime> DATANASC, global::System.Nullable<decimal> SALARIO) {
            if ((NOME == null)) {
        ...
        public virtual int Update(string NOME, global::System.Nullable<global::System.DateTime> DATANASC, global::System.Nullable<decimal> SALARIO, int Original_ID, string Original_NOME, global::System.Nullable<global::System.DateTime> Original_DATANASC, global::System.Nullable<decimal> Original_SALARIO, int ID) {
            if ((NOME == null)) {
            ...
            if ((Original_DATANASC.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(Original_DATANASC.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NOME, global::System.Nullable<global::System.DateTime> DATANASC, global::System.Nullable<decimal> SALARIO, int Original_ID, string Original_NOME, global::System.Nullable<global::System.DateTime> Original_DATANASC, global::System.Nullable<decimal> Original_SALARIO) {
            return this.Update(NOME, DATANASC, SALARIO, Original_ID, Original_NOME, Original_DATANASC, Original_SALARIO, Original_ID);
        }
    }
